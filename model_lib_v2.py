...
#   return losses_dict
  return total_loss,losses_dict,training_step #Added
    ...
    with strategy.scope():
      with tf.compat.v2.summary.record_if(
        ...
        def train_step_fn(features, labels):
          ...
          if record_summaries:
            tf.compat.v2.summary.image(
                ...
                max_outputs=3)
          tl, losses_dict, ts = eager_train_step(#Added
              detection_model,
              features,
              labels,
              unpad_groundtruth_tensors,
        ...
        #   losses_dict = _dist_train_step(train_input_iter)
          tf.config.experimental_run_functions_eagerly(True) #Added
