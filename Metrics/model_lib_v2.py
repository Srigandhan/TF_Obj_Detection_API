    ...
    with strategy.scope():
      with tf.compat.v2.summary.record_if(
        ...
        for _ in range(global_step.value(), train_steps,
          ...
          mlflow.log_metric('steps_per_sec', steps_per_sec, step=_)
          ...
          for key, val in logged_dict.items():
            ...
            mlflow.log_metric(key, val.numpy(), step=_)
...
def eager_eval_loop(
  ...
  for k in eval_metrics:
    tf.compat.v2.summary.scalar(k, eval_metrics[k].numpy(), step=int(global_step.eval()))
